 ...
 */
 function detalleClientes(nodo) {
    ...
    let nuevoCodigoHtml =
        ...
        '<td><input type="text" name="email" id="emailActualizado" value="' + nodosEnTr[1].textContent + '" style="width:200px"></td>' +
        '<td><input type="text" name="password" id="passwordActualizado" value="' + nodosEnTr[2].textContent + '" style="width:70px"></td>' +
        '<td><input type="text" name="nameCL" id="nameCLActualizado" value="' + nodosEnTr[3].textContent + '" style="width:200px"></td>' +
        '<td><input type="number" name="age" id="ageActualizado" value="' + nodosEnTr[4].textContent + '" style="width:40px"></td>' +
        '<td><button onclick="borrarCliente(' + nodosEnTr[0].textContent + ')">Borrar</button></td>' +
        '<td><button onclick=" actualizarDatosCliente(' + nodosEnTr[0].textContent + ')">Aceptar</button></td>';
