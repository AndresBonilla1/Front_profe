...
/**
 * detalleCategoria(nodo)
 * Función que hace uso de un nodo para modificar los datos de tabla
 * categoria
 * @param {Nodo con la fila de la tabla categoria} nodo 
 */
function detalleCategoria(nodo) {
    ...
    let nuevoCodigoHtml =
        ...
        '<td><input type="text" name="nameCT" id="nombreCTActulizado" value="' + nodosEnTr[1].textContent + '" style="width:100px"></td>' +
        '<td><input type="text" name="descriptionCT" id="descripcionCTActulizado" value="' + nodosEnTr[2].textContent + '" style="width:200px"></td>' +
